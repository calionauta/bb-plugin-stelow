  ...
  return (
    <>
      ...
      <WorkerSection
        card={card}
        detail={detail}
        presetStale={isWorkerPresetStale(card, detail)}
        restarting={state.actions.restarting}
        onRestartWorker={() => state.setRestartWorkerOpen(true)}
        onPreset={() => state.setPresetDialogOpen(true)}
