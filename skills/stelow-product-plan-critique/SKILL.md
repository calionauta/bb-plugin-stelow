...
The workflow loads this skill automatically after Tech Planning, before visual review.
...
and prepare it for the visual review Gate:
...
4. Prepend section **"⚡ Gate Review — Critical Decisions"** at the **top**
   ...
   via visual review annotations. The LLM reads annotations post-Gate and applies
   overrides.
