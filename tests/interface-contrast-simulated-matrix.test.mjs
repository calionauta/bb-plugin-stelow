...
const cases = [
  {
    ...
    receipt: {
      ...
      decisionQuestion: "Which context stays visible?",
  ...
  },
  {
    ...
    receipt: {
      ...
      shapeVersion: "v4",
      scopeMapVersion: "map-1",
      decisionQuestion: "Where should batch feedback appear?",
      primaryDimension: "feedback timing",
      fixedConstraints: [{ name: "undo", value: "undo after commit", source: "simulation" }],
  ...
  },
  {
    ...
    challenge: {
      ...
      reason: "A new approval actor changes the commitment.",
      disposition: "human-decision-required",
      authority: "agent",
      evidence: ["simulation:case-6"],
