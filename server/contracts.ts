...
// Whether the host's Workflows plugin is installed, enabled, and running.
// The literal ids keep the About card's copy and the handler's derivation
// reading the same nouns.
export const workflowDependencyStatusSchema = z.object({
