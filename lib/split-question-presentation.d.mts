...
export declare function splitSelectionNotice(options: Array<{ label?: string }> | null | undefined, selected: string[] | null | undefined): { kind: "keep" | "archive" | "partial"; text: string } | null;
