 ...
 * Artifact column enriches the canonical round files on the card. The
 * Opportunities section stays owned by parseResearchIndex, which drives the
 * interactive fan-out panel — so this parser never touches it.
 */
