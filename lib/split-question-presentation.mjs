...
export function splitQuestionText(question, options = []) {
  ...
  const guidance = questionLocale(base, options) === "pt-BR" ? SPLIT_QUESTION_GUIDANCE_PT : SPLIT_QUESTION_GUIDANCE;
  return base ? `${base}\n\n${guidance}` : guidance;
}
...
export function splitSelectionNotice(question, options, selected) {
  ...
  const portuguese = questionLocale(question, options) === "pt-BR";
