 ...
 * content or null. Returns [{ n, label, slug, reason }] for every invalid
 * substep, in input order. reason is missing | thin | mirrors-index.
 * Validity is the same isValidRoundContent predicate primaries use —
 * depth minima arrive in Phase 2; Phase 1 closes the presence gap.
 */
export function findInvalidSubsteps(substeps, readContent, indexBlob) {
  const invalid = [];
