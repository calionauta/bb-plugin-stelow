...
/**
 * What this receipt is, next to Stelow's portable trail in the card's Audit
 * group. Two documents whose names differ by one word are not self-explaining,
 * and they are not the same evidence: this one is the host's record of what was
 * verified, by which tests, at which checkout.
 */
export const AUDIT_RECEIPT_NOTE = "Host receipt — acceptance criteria, tests, checkout";
