...
export function validateExecutionArtifacts(options: { recipe: Record<string, any>; contents: Record<string, string>; context?: Record<string, unknown> }): { ok: boolean; missing: string[]; malformed: string[]; paths: string[] };
