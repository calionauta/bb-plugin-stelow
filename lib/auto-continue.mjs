...
export function shouldDoneNudge({ status, cardStatus, questionPending, transitioningIntoIdle, autoCount, autoStage }) {
  if (cardStatus === "completed") return { proceed: false, reason: "card already completed" };
