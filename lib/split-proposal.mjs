 ...
 */
export function splitActionState({ kind, stage, status, archived, openProposal, openQuestions }) {
  const show = kind === "build" && SPLIT_STAGES.includes(stage) && !archived && status !== "completed";
