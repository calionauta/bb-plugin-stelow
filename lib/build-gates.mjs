...
function scopeSufficiencyRefusal({ intent, scopeCount = 0, hasScopeMap = false } = {}) {
  ...
  return "Refused: this refactor has multiple delivery scopes but no approved Scope Map — return to the Scope stage, record the map and its approval receipt, then advance again.";
}
...
function untrackedRefusal({ kind, stage, at, specMachine, specHuman, specContent = null }) {
