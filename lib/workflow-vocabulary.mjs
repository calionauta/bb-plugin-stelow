 ...
 * trail; a captured-but-unstarted card sits in the Inbox because it has no
 * phase yet; otherwise the current checkpoint determines the phase column.
 *
 * The Inbox test is strictly `workerThreadId === null`: the field is part of
